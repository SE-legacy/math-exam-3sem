...
+ $Phi$ --- гладкая поверхность, заданная параметрически:
  ...
  #equ($ overline(r) = overline(r)(u,v) = (x(u,v), y(u,v), z(u,v))(u,v). $, id:<eq:7>)
...
#theorem(
	...
	$Phi$ --- гладкая поверхность, имеющая параметрическое представление (@eq:7), и функция $f(x,y,z)$ непрерывна во всех точках $Phi$. Тогда поверхностный интеграл первого рода существует и
