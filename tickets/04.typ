...
#theorem(name: "Теорема Стокса")[
	...
	Докажем, что 
	$ integral.cont P d x = limits(integral.double)_Phi (partial P)/(partial z) d x d z - limits(integral.double)_Phi (partial P)/(partial y) d x d y $
	...
	= limits(integral.cont)_(L*) P(x(u,v), y(u,v), z(u,v))((partial x)/(partial y) d u + (partial x)/(partial v) d v) = limits(integral.cont)_(L*) P (partial x)/(partial u) d u + P (partial x)/(partial v) d v =^"по формуле Грина" \
	= limits(integral.double)_D (((partial P)/(partial u) (partial x)/(partial u) + (partial P)/(partial y) (partial y)/(partial u) + (partial P)/(partial z) (partial z)/(partial u)) (partial x)/(partial v) + P (partial^2 x)/(partial u partial v)) d u d v - \
	...
	= limits(integral.double)_D ((partial P)/(partial z) B - (partial P)/(partial y) C) = integral.double_Phi (partial P)/(partial z) d z d x - (partial P)/(partial y) d x d y $

	2. Аналогично доказываются равенства
	$ limits(integral.cont)_L Q d y = integral.double_Phi (partial Q)/(partial x) d x d y - (partial Q)/(partial z) d y d z, $
	$ limits(integral.cont)_L R d z = integral.double_Phi (partial R)/(partial y) d y d z - (partial R)/(partial x) d z d x. $
