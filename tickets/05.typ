...
#theorem[
	...
	$ limits(integral.double)_Phi_k R(x, y, z) dif x dif y = limits(integral.triple)_V_k frac(diff R, diff z) dif x dif y dif z, k = overline(1\,m), $
	причём
	$ limits(sum)_(k = 1)^m limits(integral.double)_Phi_k R(x, y, z) dif x dif y = limits(sum)_(k = 1)^m limits(integral.triple)_V_k frac(diff R, diff z) dif x dif y dif z = limits(integral.triple)_V frac(diff R, diff z) dif x dif y dif z $
