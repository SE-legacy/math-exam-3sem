#import "../functions.typ": theorem, definition, lemma
= Тригонометрический ряд. Коэффициенты Фурье и ряд Фурье. Ядро Дирихле

#definition()[
  Если $f in Re_([-pi;pi])$, то числа $a_0, a_1, b_1, ...,  a_n, b_n, ...$ называют *коэффициентами Фурье*, а ряд
   $
    a_0/2 + limits(sum)_(n=1)^infinity (a_n cos n x + b_n sin n x)
   $
   называют *рядом Фурье* функции $f$.
]
