...
#theorem(
	name: "Теорема (принцип локализации Римана)",
)[
...
$ alpha_n (x) -> 0 " при " n -> infinity. $
  ...
  Представим правую часть равенства (@fla37) в виде суммы двух интегралов:

  $
  S_n(x) = 1/pi limits(integral)_0^pi (f(x + t) + f(x - t)) (sin (2 n + 1)/2 t)/(2 sin t/2) d t =\
  = 1/pi limits(integral)_0^a (f(x + t) + f(x - t)) (sin (2 n + 1)/2 t)/(2 sin t/2) d t +  1/pi limits(integral)_a^pi (f(x + t) + f(x - t)) (sin (2 n + 1)/2 t)/(2 sin t/2) d t .
  $
