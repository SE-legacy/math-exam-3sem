...
При разложении в ряд Фуре функции заданной на отрезке $[a; a+2pi]$, для вычисления коэффициентов в качестве пределов интегрирования следует брать концы этого отрезка.
